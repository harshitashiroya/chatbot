...
# Streamlit UI
st.title("FinGuard - NBC Banking Chatbot")  # Set the title of the Streamlit app
st.write("Hello! I am FinGuard.🤖")
...
def handle_input():
    ...
    st.session_state.chat_history.append(f"FinGuard: {response}")
